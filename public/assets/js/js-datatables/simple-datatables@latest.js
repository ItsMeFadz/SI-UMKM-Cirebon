                                ...
                                case "html":
                                    {
                                        const t = Array.isArray(s.data) ? {
                                            nodeName: "TD",
                                            childNodes: s.data
                                        } : k(`<td>${String(s.data)}</td>`);s.data = t.childNodes || [];
                                        const e = a(t);s.text = e,
                                        s.order = e;
                                        break
                                    }
                                case "boolean":
                            ...
                            if (t.data ? o.data = t.data.map((t => t.map(((t, e) => z(t, s[e]))))) : e ? .tBodies ? .length && (o.data = Array.from(e.tBodies[0].rows).map((t => Array.from(t.cells).map(((t, e) => {
                                    const i = t.dataset.content ? z(t.dataset.content, s[e]) : ((t, e) => {
                                        ...
                                        switch (e.type) {
                                            ...
                                            case "boolean":
                                                {
                                                    const e = !["false", "0", "null", "undefined"].includes(t.innerText.toLowerCase().trim());s = {
                                                        data: e,
                                                        order: e ? 1 : 0,
                                                        text: e ? "1" : "0"
                                                    };
